        ...
        <div className="md:w-8/12 bg-white px-8 py-8 lg:px-12 lg:py-10 flex flex-col justify-center h-full overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-4 mt-8 pt-2">
              <button
                type="submit"
                className="flex-1 relative overflow-hidden bg-[#1A73E8] text-white font-semibold py-2.5 px-6 rounded-lg transition-all shadow-md hover:shadow-xl hover:shadow-[#1A73E8]/40 text-xs transform hover:-translate-y-0.5 group"
              >
                {/* Shimmer Effect */}
                <div className="absolute inset-0 w-[200%] h-full bg-linear-to-r from-transparent via-sky-300/20 to-transparent -translate-x-full animate-[shimmer_3s_infinite] group-hover:via-purple-400/30 group-hover:to-blue-500/30"></div>
