      ...
      <div className="w-full max-w-5xl bg-white rounded-xl shadow-[0_35px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden flex flex-col md:flex-row h-[600px] max-h-[90vh]">
        ...
        <div className="md:w-4/12 bg-[#1A73E8] relative flex items-center justify-center p-8 overflow-hidden">
          ...
          >
            ...
            <path
              d="M100 100 C 60 90 40 50 80 0 L 100 0 Z"
              fill="currentColor"
              opacity="0.5"
            />
          </svg>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 mt-8 pt-2">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-[#1A73E8] hover:bg-[#3D5AFE] text-white font-semibold py-3 px-6 rounded-lg transition-all shadow-md hover:shadow-xl hover:shadow-[#3D5AFE]/40 text-sm transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
