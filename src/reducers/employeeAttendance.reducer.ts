...
export const fetchMonthlyAttendance = createAsyncThunk(
  ...
  async ({
    ...
    const response = await axios.get(
      `${apiUrl}/monthly-details/${employeeId}/${month}/${year}`,
    );
...
export const fetchAllEmployeesMonthlyAttendance = createAsyncThunk(
  ...
  async ({ month, year }: { month: string; year: string }) => {
    const response = await axios.get(
      `${apiUrl}/monthly-details-all/${month}/${year}`,
    );
    return response.data;
  },
);
...
export const fetchAttendanceByDateRange = createAsyncThunk(
  ...
  async ({
    ...
    const response = await axios.get(
      `${apiUrl}/date-range/${employeeId}/${startDate}/${endDate}`,
    );
    return response.data;
  },
);
...
export const fetchWorkedDays = createAsyncThunk(
  ...
  async ({
    ...
    const response = await axios.get(
      `${apiUrl}/worked-days/${employeeId}/${startDate}/${endDate}`,
    );
    return response.data;
  },
);
...
export const fetchDashboardStats = createAsyncThunk(
  ...
  async ({
    ...
    const response = await axios.get(
      `${apiUrl}/dashboard-stats/${employeeId}`,
      {
        params: { month, year },
      },
    );
...
export const submitBulkAttendance = createAsyncThunk(
  ...
  async (data: Partial<EmployeeAttendance>[]) => {
    ...
    const response = await axios.post(
      `${apiUrl}/attendance-data/${employeeId}`,
      data,
    );
    return response.data;
  },
...
// 10. Auto Update Timesheet: POST /auto-update
export const autoUpdateTimesheet = createAsyncThunk(
  "attendance/autoUpdate",
  async ({
    employeeId,
    month,
    year,
...
const attendanceSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentDayRecord: (
      state,
      action: PayloadAction<EmployeeAttendance | null>,
    ) => {
    ...
    builder
      ...
      .addCase(
        ...
        (
          ...
          action: PayloadAction<EmployeeAttendance[]> | any,
        ) => {
          state.loading = false;
      ...
      .addCase(
        fetchAllEmployeesMonthlyAttendance.fulfilled,
        (
          state: AttendanceState,
      ...
      .addCase(
        fetchAttendanceByDateRange.fulfilled,
        (
          state: AttendanceState,
          action: PayloadAction<EmployeeAttendance[]>,
        ) => {
      ...
      .addCase(
        fetchWorkedDays.fulfilled,
        (state: AttendanceState, action: PayloadAction<any>) => {
          state.loading = false;
      ...
      .addCase(
        deleteAttendanceRecord.fulfilled,
        (state: AttendanceState, action: PayloadAction<number>) => {
          state.loading = false;
      ...
      .addCase(
        submitBulkAttendance.fulfilled,
        (
          state: AttendanceState,
          action: PayloadAction<EmployeeAttendance[] | any>,
        ) => {
