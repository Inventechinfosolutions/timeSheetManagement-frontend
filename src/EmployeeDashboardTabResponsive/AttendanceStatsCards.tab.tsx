...
const AttendanceStatsCardsTab = ({ values }: Props) => {
  return (
    <div className="attendance-stats-tab">
      <div className="attendance-stats-grid attendance-stats-grid--tab">
        ...
        <div className="attendance-balance-card attendance-balance-card--tab">
...
export default AttendanceStatsCardsTab;
