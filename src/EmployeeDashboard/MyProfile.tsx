...
// Import Responsive Mobile Layout View
import MyProfileResponsive from "./MobileMyProfile/MyProfileResponsive";

import { GenderDisplay } from "./MobileMyProfile/MyProfileResponsive.enum";
...
const MyProfile = () => {
  ...
  // If running on a mobile viewport view, route layout over to the responsive block component
  if (isMobile) {
    return (
      <MyProfileResponsive
        fullName={fullName}
  ...
  return (
    <div className="overflow-y-auto no-scrollbar px-5 md:px-8 pt-4 pb-0 w-full mx-auto animate-in fade-in duration-500 space-y-3 md:space-y-4">
      {/* Back Button */}
      <button
      ...
      <div className="bg-white rounded-[20px] md:rounded-[32px] p-6 md:p-8 border border-gray-100 mb-6 md:mb-8">
      ...
      {/* Profile Image View/Action Modal */}
      <Modal
