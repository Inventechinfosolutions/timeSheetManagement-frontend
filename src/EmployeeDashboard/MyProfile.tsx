...
import { Camera, Mail, Briefcase, User, Building, CreditCard } from 'lucide-react';

const MyProfile = () => {
    const [profileImage, setProfileImage] = useState("https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=2576&auto=format&fit=crop");
    ...
    return (
        <div className="p-8 w-full max-w-[1600px] mx-auto animate-in fade-in duration-500 space-y-8">
            ...
            <div className="bg-white rounded-[20px] p-8 shadow-sm border border-gray-100 flex items-center gap-6 relative overflow-hidden">
                <div className="relative group cursor-pointer inline-block" onClick={handleCameraClick}>
                    <input
                        type="file"
                        ref={fileInputRef}
                ...
                <div>
                    <h1 className="text-2xl font-bold text-[#2B3674]">Natashia Khaleira</h1>
            ...
            <div className="bg-white rounded-[20px] p-8 shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                    <h2 className="text-lg font-bold text-[#2B3674]">Personal Information</h2>
                </div>
                <div className="mb-8">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative group">
                            <input
                                type="text"
                                disabled
                                defaultValue="Natashia Khaleira"
                    ...
                    <div className="space-y-1 md:col-span-2">
                        ...
                        <div className="relative group">
                            <input
                                type="email"
                                disabled
                                defaultValue="natashia.k@inventech.com"
                                className="w-full pl-9 pr-3 py-2.5 border border-gray-100 rounded-xl bg-[#F4F7FE] text-[#2B3674] text-xs font-medium"
                            />
