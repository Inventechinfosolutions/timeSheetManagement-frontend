  ...
  return (
    <div className="flex w-full h-full bg-[#f8f9fa] font-sans text-[#2B3674] overflow-hidden relative">
      ...
      >
        ...
        {/* Navigation Items */}
        <nav
          className="flex-1 px-4 space-y-2 mt-1 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:hidden [&::webkit-scrollbar]:w-0 [&::-webkit-scrollbar]:h-0"
            ...
            return (
              <div key={item.name} className="relative group">
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-3 rounded-2xl cursor-pointer transition-all duration-300 relative overflow-hidden group
                                        ${
                                          isActive
