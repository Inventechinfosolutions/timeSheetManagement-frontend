    ...
    <div className="animate-in fade-in duration-500">
      ...
      >
            ...
            {monthDays.map((day) => {
              ...
              return (
                <div
                  ...
                  } mx-auto rounded-lg flex items-center justify-center font-bold transition-all hover:scale-105 cursor-pointer relative
        ...
        >
          ...
          {/* Hide extra items on sidebar if too crowded? No they fit. */}
          <div
            className={`flex items-center text-gray-400 font-medium ${
              isSmall
                ? "gap-1 text-[8px]"
