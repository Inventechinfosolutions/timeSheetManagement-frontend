...
            <button
              ...
              className={`flex-1 py-3.5 rounded-2xl bg-[#4318FF] text-white font-black text-sm shadow-lg shadow-blue-500/30 transition-all active:scale-95 ${
                loading ||
                (!Number.isNaN(parseFloat(mobileInputModal.value)) &&
                  parseFloat(mobileInputModal.value) > 9)
...
          <div className="mobile-timesheet-toolbar bg-white rounded-[20px] px-4 py-3 shadow-sm border border-gray-50 mb-3">
...
                </button>
                <p className="text-xs font-black text-[#2B3674] min-w-[110px] text-center">
...
            <div className="mobile-timesheet-summary-row flex items-center gap-2 px-2 mb-3">
              <div className="mobile-timesheet-total flex items-baseline gap-1 flex-shrink-0 min-w-0">
                <p className="text-[9px] uppercase font-black text-gray-600 tracking-wider leading-none whitespace-nowrap">
                  TOTAL TRACKED :
                </p>
                <p className="text-base font-black text-[#4318FF] leading-none whitespace-nowrap">
                  {PlatformTotalHoursFix(monthTotalHours)}
                </p>
                <span className="text-[8px] font-bold text-gray-500">hrs</span>
              </div>
              <div className="mobile-timesheet-actions flex items-center gap-2 ml-auto flex-shrink-0">
                {(!effectiveReadOnly ||
                  (isAdmin && !isAdminView) ||
...
                      className="flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg font-black text-[8px] uppercase tracking-wide text-white transition-all active:scale-95 bg-[#4318FF] whitespace-nowrap"
...
                      ${isSplitDay ? "" : toneClasses.bg} ${toneClasses.border} ${highlightClass}
                      ${day.isToday ? "ring-2 ring-[#4318FF] ring-offset-1" : ""}
